...
public class AlunoController {
    ...
    /**
     * Retorna os dados do aluno atualmente logado.
     * Acessível por qualquer usuário autenticado com perfil ALUNO.
     *
     * GET /alunos/me
     */
    @GetMapping("/me")
    public ResponseEntity<?> getMe(Authentication authentication) {
        ...
        try {
            ...
            // Usuário autenticado ainda não tem registro de aluno
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
